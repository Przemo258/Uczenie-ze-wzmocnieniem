...
class SarsaAgent:
    ...
    def update(self, state, action, reward, next_state, next_action):
        ...
        # YOUR CODE HERE
        diff = self.gamma * self.Q_est[next_state][next_action] - self.Q_est[state][action]
        self.Q_est[state][action] = self.Q_est[state][action] + self.alpha * (reward + diff)
...
class QLearningAgent:
    ...
    def update(self, state, action, reward, next_state):
        ...
        # YOUR CODE HERE
        diff = self.gamma * np.max(self.Q_est[next_state]) - self.Q_est[state][action]
        self.Q_est[state][action] = self.Q_est[state][action] + self.alpha * (reward + diff)
